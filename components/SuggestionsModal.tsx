    ...
    >
      ...
      >
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          <h2 id="suggestions-modal-title" className="text-lg font-semibold text-purple-300 truncate pr-4">{title}</h2>
        ...
        <div className="p-6 overflow-y-auto">
          {isLoading ? (
            <p className="text-gray-400 text-center" role="status" aria-live="polite">Thinking...</p>
            ...
            <p className="text-gray-500 text-center" role="status" aria-live="polite">No suggestions found.</p>
          )}
        </div>
      </div>
    </div>
